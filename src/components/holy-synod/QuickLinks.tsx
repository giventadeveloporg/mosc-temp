          ...
          {quickLinks.map((link) => {
            const linkContent = (
              <>
                ...
                <span className="font-body text-xs text-foreground hover:text-primary reverent-transition whitespace-nowrap">
                  {link.name}
                </span>
              </>
            );
            ...
            if (link.external) {
              return (
                <a
                  ...
                  className="flex items-center px-2 py-1.5 bg-muted rounded-md hover:bg-primary/5 hover:scale-105 reverent-transition border border-border"
                >
                  {linkContent}
                </a>
              );
            ...
            if (link.external) {
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center px-4 py-2 bg-background rounded-lg sacred-shadow hover:bg-primary/5 hover:scale-105 reverent-transition border border-border"
                >
                  {linkContent}
                </a>
              );
