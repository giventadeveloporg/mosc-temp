...
import { uploadEventSponsorPosterServer } from '@/app/admin/event-sponsors/ApiServerActions';
...
export default function EventSponsorPosterUploadDialog({
  ...
  onClose,
  onUploadSuccess,
}: EventSponsorPosterUploadDialogProps) {
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 justify-center">
                    ...
                    <button
                      type="button"
                      onClick={resetForm}
                      className="flex-shrink-0 h-14 rounded-xl bg-red-100 hover:bg-red-200 flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 px-4"
                      title="Remove"
                      aria-label="Remove"
                    >
