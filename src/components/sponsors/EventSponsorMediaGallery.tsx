...
export default function EventSponsorMediaGallery({
  eventId,
  sponsorId,
  onMediaSelect,
  onMediaDelete,
  ...
  useEffect(() => {
    const loadMedia = async () => {
      ...
      try {
        ...
        console.error('Failed to fetch event-sponsor media:', error);
  ...
  if (mediaList.length === 0) {
    return (
      <div className="text-center p-8 bg-card rounded-lg border border-border">
        ...
        <p className="font-body text-muted-foreground mb-4">No media files found for this event-sponsor combination.</p>
