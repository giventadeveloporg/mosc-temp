...
const SECTION_LINKS = [
  { label: 'Main News', href: '/mosc-redesign/news#main-news' },
  { label: 'Featured News', href: '/mosc-redesign/news#featured-news' },
  { label: 'Press Release', href: '/mosc-redesign/news#press-release' },
  { label: 'Most Read', href: '/mosc-redesign/news#most-read' },
] as const;
