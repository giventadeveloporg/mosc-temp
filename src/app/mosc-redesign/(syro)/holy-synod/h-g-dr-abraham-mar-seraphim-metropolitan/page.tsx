            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,rgba(0,0,0,0.3)_0px_3px_7px_-3px] px-4 py-8 md:p-8">
                ...
                <div className="mb-8 flex justify-center">
                  <Image src="/images/holy-synod/sera.png" alt="H.G. Dr. Abraham Mar Seraphim Metropolitan" width={125} height={75} className="rounded-lg w-full max-w-[290px] md:max-w-[125px] h-auto object-contain" priority />
                  </div>
