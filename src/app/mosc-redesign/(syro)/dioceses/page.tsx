...
const DiocesesPage = () => {
  ...
  const dioceseCards = [
    ...
    { name: 'Diocese of Niranam', href: '/mosc-redesign/dioceses/diocese-of-niranam', excerpt: 'Niranam is a beautiful village situated in the delta of rivers Pampa and Manimala: part of Thiruvalla taluk and Pathanamthitta district. This is a typical Keralite agricultural village, full of natural beauty.', image: '/images/dioceses/diocese-of-niranam.jpg' },
    { name: 'Diocese of Nilackal', href: '/mosc-redesign/dioceses/diocese-of-nilackal', excerpt: 'The Diocese of Nilackal came into being on August 15, 2010 under the order issued by H.H Baselios Mar Thoma Didymos I, The Catholicos cum Malankara Metropolitan. H.G. Dr. Joshua Mar Nicodimos is the first Metropolitan.', image: '/images/dioceses/diocese-of-nilackal.jpg' },
    ...
    { name: 'Diocese of Sulthan Bathery', href: '/mosc-redesign/dioceses/diocese-of-sulthan-bathery-diocese', excerpt: 'In 1986, the diocese of Sultan Bathery was formed by organising all the churches from the District of Wayanad, some of the churches from the Nilagiri District of Tamilnadu and some from Karnataka.', image: '/images/dioceses/sulthan_bathery_diocese.jpg' },
    { name: 'Diocese of Brahamavar', href: '/mosc-redesign/dioceses/diocese-of-brahamavar', excerpt: 'The Diocese of Brahmavar was formed in August 2010 and was announced by His Holiness Baselios Marthoma Didymus I through the Kalpana No.389/2010 dated 3-8-2010. The formation was with the goal of shepherding the faithful in the region.', image: '/images/dioceses/bhramavar_diocese.jpg' },
    ...
    { name: 'Diocese of Delhi', href: '/mosc-redesign/dioceses/diocese-of-delhi', excerpt: 'Once the nucleus of the Orthodox Church in north India was formed in the capital of the country, the growth of parishes in adjacent centres was rapid and the establishment of the Delhi Diocese followed.', image: '/images/dioceses/diocese-of-delhi.jpg' },
    ...
    { name: 'Diocese of UK Europe and Africa', href: '/mosc-redesign/dioceses/diocese-of-uk-europe-and-africa', excerpt: 'Diocese of the Indian Orthodox Church, UK Europe and Africa is acting as the umbrella organisation for various Indian Orthodox parishes in the UK, Rest of Europe and African Continent.', image: '/images/dioceses/diocese-of-uk-europe-and-africa.jpg' },
    { name: 'ASIA PACIFIC', href: '/mosc-redesign/dioceses/asia-pacific', excerpt: 'The Asia Pacific diocese serves the faithful in the Asia Pacific region with its office in Canberra, Australia.', image: '/images/dioceses/asia-pacific-diocese.webp' },
    { name: 'CANADA', href: '/mosc-redesign/dioceses/canada', excerpt: 'The Canada diocese serves the Malankara Orthodox Syrian Church community across Canada with its office in Hamilton, Ontario.', image: '/images/dioceses/canda-diocese.webp' }
  ];
