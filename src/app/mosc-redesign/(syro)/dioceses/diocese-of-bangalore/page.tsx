                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <div className="mt-8 flex max-w-xl overflow-hidden rounded-lg border border-syro-table-border bg-syro-bg-gray shadow-syro-card">
                    ...
                    <div className="flex-1 p-5 font-syro-primary text-syro-dark-gray leading-relaxed space-y-2 text-sm">
                      ...
                      <p>
                        <span className="font-semibold">Ph:</span> 09611353977
                      </p>
                      <p>
                        <span className="font-semibold">E-mail:</span>{' '}
                        <a href="mailto:moc.bangalorediocese@gmail.com" className="text-syro-red hover:underline font-medium">moc.bangalorediocese@gmail.com</a>
                      </p>
                      <p>
                        <a
                          href="https://maps.app.goo.gl/fJiNJcuK7By8TnfYA"
                          target="_blank"
