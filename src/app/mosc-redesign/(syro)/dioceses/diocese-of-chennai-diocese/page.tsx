...
const dioceseofchennaidiocesePage = () => {
  return (
    <div className="bg-syro-bg-gray">
      <SyroPageBanner title="Diocese of Madras" breadcrumbFrom="dioceses" />
                  ...
                  <div className="mt-8 flex max-w-xl overflow-hidden rounded-lg border border-syro-table-border bg-syro-bg-gray shadow-syro-card">
                    ...
                    <div className="flex-1 p-5 font-syro-primary text-syro-dark-gray leading-relaxed space-y-2 text-sm">
                      <p className="mb-1">
                        ...
                        <br />
                        Bishop&apos;s House, 4/51, Rajeswari Street,
                        <br />
                        Mehta Nagar, Chennai -600 029.
                      </p>
                      <p>
                        <span className="font-semibold">Ph:</span> 044-23746010, 23746011
                      </p>
                      <p>
                        <span className="font-semibold">E-mail:</span>{' '}
                        <a href="mailto:madrasorthodoxdiocese@gmail.com" className="text-syro-red hover:underline font-medium">madrasorthodoxdiocese@gmail.com</a>
                      </p>
                      <p>
                        <a
                          href="https://maps.app.goo.gl/Yr4qo8Ri8KhWL1tGA"
                          target="_blank"
