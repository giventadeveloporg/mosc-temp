  ...
  const institutions = [
    {
      ...
      link: '/mosc-redesign/institutions/major-centres',
    },
    {
      id: 'monasteries',
      title: 'Monasteries',
      ...
      link: '/mosc-redesign/institutions/monasteries',
    },
    {
      id: 'convents',
      title: 'Convents',
      ...
      link: '/mosc-redesign/institutions/convents',
    },
    {
      id: 'orphanages',
      title: 'Orphanages',
      ...
      link: '/mosc-redesign/institutions/orphanages',
    },
    {
      id: 'hospitals',
      title: 'Hospitals',
      ...
      link: '/mosc-redesign/institutions/hospitals',
    },
    {
      id: 'medical-college',
      ...
      link: '/mosc-redesign/institutions/medical-college',
    },
    {
      ...
      link: '/mosc-redesign/institutions/engineering-colleges',
    },
    {
      id: 'moc-colleges',
      title: 'MOC Colleges',
      ...
      link: '/mosc-redesign/institutions/moc-colleges',
    },
    {
      id: 'schools',
      title: 'Schools',
      ...
      link: '/mosc-redesign/institutions/schools',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {institutions.map((institution) => (
              ...
              >
                <MoscHubCardMedia src={institution.image} alt={institution.title} />
