...
/**
 * Fetches all spiritual organisation entries for the current tenant, sorted by display order.
 */
...
/**
 * Fetches a single spiritual organisation entry by slug. Returns null if not found or on error.
 */
