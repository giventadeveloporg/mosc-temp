...
const QUICK_LINKS = [
  { name: 'CATHOLICATE NEWS', href: '/mosc-redesign/news' },
  { name: 'DOWNLOADS', href: '/mosc-redesign/downloads' },
  { name: 'E-MAIL', href: '/mosc-redesign/email' },
  { name: 'GALLERY', href: '/mosc-redesign/gallery' },
  { name: 'CONTACT INFO', href: '/mosc-redesign/contact-info' },
];
          ...
          <div className="col-lg-4 footer-section-11 d-none d-lg-block">
            <ul className="list-unstyled">
              <li className="float-end copy-right">
                <Link href="/mosc-redesign">© {currentYear()} The Malankara Orthodox Church. All rights reserved.</Link>
              </li>
            </ul>
          </div>
