...
const SAINTS = [
  { name: 'St.Mary Mother of God', image: '/mosc/assets/images/mosc_images/St_Mother_Mary.jpg', href: '/mosc-redesign/saints/st-mary-mother-of-god' },
  { name: 'St. Baselios Yeldho', image: '/mosc/assets/images/mosc_images/St_Baselios_Yeldho.jpg', href: '/mosc-redesign/saints/st-baselios-yeldho-kothamangalam-bava' },
  { name: 'St. Geevarghese', image: '/mosc/assets/images/mosc_images/St_Geevarghese.jpg', href: '/mosc-redesign/saints/st-geevarghese-mar-dionysius-vattasseril' },
  { name: 'St. Gregorios Of Parumala', image: '/mosc/assets/images/mosc_images/St_Gregorios_Parumala.jpg', href: '/mosc-redesign/saints/st-gregorios-of-parumala-metropolitan-geevarghese-mar-gregorios' },
] as const;
