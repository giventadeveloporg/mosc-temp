...
const SAINTS_CARDS = [
  ...
  },
  {
    ...
    href: '/mosc-redesign/saints/early-church-father',
  ...
  },
  {
    ...
    href: '/mosc-redesign/saints/other-saints-and-martyrs',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {SAINTS_CARDS.map((card) => (
              ...
              >
                <MoscHubCardMedia src={card.image} alt={card.title} objectPosition="top" frameClassName="bg-white" />
