...
const downloadItems: { title: string; link: string; image?: string }[] = [
  ...
  { title: 'Download Photos', link: '/mosc-redesign/downloads/photos', image: '/images/downloads/download-photos.png' },
  { title: 'Medical Insurance', link: '#', image: '/images/downloads/medical_insurance.png' },
  { title: 'Kalpana', link: '/mosc-redesign/downloads/kalpana', image: '/images/downloads/kalpana.png' },
  ...
  { title: 'Application Forms', link: '/mosc-redesign/downloads/application-forms', image: '/images/downloads/application_forms.jpg' },
  ...
  { title: 'Pdfs', link: '/mosc-redesign/downloads/pdfs', image: '/images/downloads/pdfs.jpg' },
  ...
  { title: 'Prayer Books', link: '/mosc-redesign/downloads/prayer-books', image: '/images/downloads/prayer_books.jpg' },
  { title: 'Foreign Contributions', link: '#' },
  { title: 'Online Resourses', link: '#', image: '/images/downloads/online_resources.jpg' },
  { title: 'Photos', link: '/mosc-redesign/downloads/photos', image: '/images/downloads/photos.jpg' },
];
