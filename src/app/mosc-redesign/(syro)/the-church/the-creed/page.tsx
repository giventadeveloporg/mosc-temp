              ...
              <div className="bg-white rounded-lg shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,rgba(0,0,0,0.3)_0px_3px_7px_-3px] p-8">
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <div className="bg-syro-bg-gray rounded-lg p-6 mb-8 border border-syro-table-border">
                    ...
                    <p className="font-syro-primary text-syro-dark-gray leading-relaxed italic mt-4">
                  ...
                  <div className="bg-syro-bg-gray rounded-lg p-6 border border-syro-table-border space-y-4">
                    <p className="font-syro-primary text-syro-dark-gray leading-relaxed text-sm">
