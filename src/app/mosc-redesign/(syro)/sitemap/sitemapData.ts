...
export const MOSC_REDESIGN_SITEMAP: SitemapSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Church Dignitaries', href: `${BASE}/church-dignitaries-cms` },
      { name: 'Working Committee', href: `${BASE}/working-committee-cms` },
      { name: 'Managing Committee', href: `${BASE}/managing-committee-cms` },
      { name: 'Spiritual Organisations', href: `${BASE}/spiritual-organizations-cms` },
      { name: 'Pilgrim Centres', href: `${BASE}/pilgrim-centres-cms` },
      { name: 'Seminaries', href: `${BASE}/theological-seminaries-cms` },
    ],
  },
  {
    ...
    links: [
      ...
      { name: 'Current Managing Committee', href: `${BASE}/administration/managing-committee-members` },
