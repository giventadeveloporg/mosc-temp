...
import DonationSuccessClient from '../../donation/success/DonationSuccessClient';
...
export default async function OfferingSuccessPage({ params, searchParams }: SuccessPageProps) {
  ...
  // Reuse DonationSuccessClient for offering success (same flow)
  return (
