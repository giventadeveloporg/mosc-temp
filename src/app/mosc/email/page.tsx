...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with the Malankara Orthodox Syrian Church. Send us your questions, feedback, or prayer requests.',
};
          ...
          <div className="bg-card rounded-lg sacred-shadow p-8 md:p-12">
            <div className="flex items-center space-x-4 mb-8">
              ...
              <div>
                ...
                <p className="font-body text-sm text-muted-foreground">Fill out the form below and we'll respond promptly</p>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg sacred-shadow p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@mosc.in" className="font-body text-primary hover:underline reverent-transition">
                    info@mosc.in
                  </a>
                </div>
              </div>
            ...
            <div className="bg-card rounded-lg sacred-shadow p-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:+914812300700" className="font-body text-primary hover:underline reverent-transition">
                    +91-481-2300-700
                  </a>
                </div>
              </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <address className="font-body text-muted-foreground not-italic leading-relaxed">
                  ...
                  Devalokam P.O., (Via) Muttambalam<br />
                  Kottayam – 686 004<br />
                  Kerala, India
                </address>
              </div>
