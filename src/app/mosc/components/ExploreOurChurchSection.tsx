...
const ExploreOurChurchSection = () => {
  const exploreCards = [
    { title: 'About Our Church', icon: 'church', description: 'Discover the rich history, beliefs, and spiritual life of the Malankara Orthodox Syrian Church, tracing back to St. Thomas the Apostle.', href: '/mosc/the-church' },
    { title: 'Services & Worship', icon: 'calendar', description: 'Learn about our Holy Qurbana, daily prayers, and spiritual liturgical services that form the heart of our worship.', href: '/mosc/the-church' },
    { title: 'Clergy & Leadership', icon: 'people', description: 'Meet our spiritual leaders, bishops, and clergy who guide our diocesan governance and pastoral care.', href: '/mosc/holy-synod' },
    { title: 'Contact & Location', icon: 'map', description: 'Find church locations, contact information, and directions to connect with our local parishes and communities.', href: '/mosc/contact-info' }
  ];
