...
const RecentAnnouncementsSection = () => {
  const announcements = [
    { id: 1, title: 'Christmas Season Services', date: '10 Dec 2023', icon: 'star', excerpt: 'Join us for our special Advent prayer services, Christmas Eve celebrations, Christmas Day Holy Qurbana, and New Year services as we celebrate the birth of our Lord and Savior Jesus Christ.', link: '/mosc/news' },
    { id: 2, title: 'Parish Council Meeting', date: '10 Dec 2023', icon: 'calendar', excerpt: 'The monthly parish council meeting will discuss upcoming events, community outreach programs, and review the progress of various parish initiatives.', link: '/mosc/news' },
    { id: 3, title: 'Youth Fellowship Retreat', date: '10 Dec 2023', icon: 'people', excerpt: 'Annual youth fellowship retreat with the theme "Walking in Faith" - a spiritual journey for young adults to deepen their relationship with God and build lasting friendships.', link: '/mosc/news' }
  ];
