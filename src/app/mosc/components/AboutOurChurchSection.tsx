          ...
          <div className="lg:col-span-1">
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-syro-card p-6">
                ...
                <button
                  onClick={() => handleLinkClick({ href: '/mosc/downloads/kalpana', label: 'DOWNLOAD', isInternal: true })}
        ...
        <div className="mt-12">
          <div className="bg-syro-bg-gray/20 rounded-lg p-6">
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm font-syro-primary text-syro-dark-gray">
              ...
              <span>•</span>
              <button onClick={() => handleLinkClick({ href: '/mosc/downloads', label: 'DOWNLOADS', isInternal: true })} className="hover:text-syro-red transition-all duration-300">
                DOWNLOADS
              </button>
              <span>•</span>
              <button onClick={() => handleLinkClick({ href: '/mosc/contact-form-email', label: 'E-MAIL', isInternal: true })} className="hover:text-syro-red transition-all duration-300">
                E-MAIL
              </button>
              <span>•</span>
              <button onClick={() => handleLinkClick({ href: '/mosc/gallery', label: 'GALLERY', isInternal: true })} className="hover:text-syro-red transition-all duration-300">
                GALLERY
              </button>
              <span>•</span>
              <button onClick={() => handleLinkClick({ href: '/mosc/contact-info', label: 'CONTACT INFO', isInternal: true })} className="hover:text-syro-red transition-all duration-300">
                CONTACT INFO
              </button>
            </div>
          </div>
