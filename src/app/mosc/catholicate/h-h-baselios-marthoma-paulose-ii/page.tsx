            ...
            <div className="space-y-6">
              ...
              <div className="bg-background rounded-lg sacred-shadow p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <span className="font-medium text-foreground">Elected Catholicos Designate:</span>
                    <p className="text-sm text-muted-foreground">12 October 2006</p>
                  </div>
                  <div>
                    <span className="font-medium text-foreground">Enthroned:</span>
                    <p className="text-sm text-muted-foreground">1 November 2010</p>
                  </div>
                  <div>
