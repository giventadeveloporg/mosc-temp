            ...
            <div className="space-y-6">
              ...
              <div className="bg-background rounded-lg sacred-shadow p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <span className="font-medium text-foreground">Elected Successor-Designate:</span>
                    <p className="text-sm text-muted-foreground">10 September 1992</p>
                  </div>
                  <div>
                    <span className="font-medium text-foreground">Enthroned as Catholicos:</span>
                    <p className="text-sm text-muted-foreground">31 October 2005</p>
                  </div>
                  <div>
