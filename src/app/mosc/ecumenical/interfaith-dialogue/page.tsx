...
const interfaithdialoguePage = () => {
  return (
    <div className="bg-syro-bg-gray">
      <SyroPageBanner title="Interfaith Dialogue" breadcrumbFrom="ecumenical" />
...
His Holiness the Catholicos visited Vienna en route Rome and received the hospitality of Pro-Oriente. Pro-Oriente gave the initial spark for the dialogue â€¢ between Catholics and Orthodox Churches. The Catholicos stayed at Vienna as the guest of Cardinal Christoph Schonborn, the Arch Bishop of Roman Catholic Church in Vienna. His Holiness presided over an Ecumenical meeting organized by St. Thomas Orthodox Parish in Vienna.
