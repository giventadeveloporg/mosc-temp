    ...
    <div className="min-h-screen bg-background">
      <section className="relative bg-gradient-to-br from-background to-muted py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/mosc/directory/parishes" className="font-body text-primary hover:underline mb-4 inline-block">← Parishes</Link>
      ...
      <section className="py-12 bg-card">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8">
            <Link href="/mosc/directory/parishes" className="font-body text-primary font-medium hover:underline">← Back to Parishes</Link>
          </div>
        </div>
      </section>
    </div>
