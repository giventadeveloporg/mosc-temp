...
import { koodoshEethoPeriods } from './koodoshEethoData';
...
export default function KoodoshEethoToKothnePage() {
  return (
    <div className="bg-syro-bg-gray">
      <SyroPageBanner title="Koodosh Eetho to Kothne" breadcrumbFrom="lectionary" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,rgba(0,0,0,0.3)_0px_3px_7px_-3px] p-8">
                ...
                <div className="space-y-12">
                  {koodoshEethoPeriods.map((period, index) => (
            ...
            <div className="space-y-6 lg:col-span-1">
              <LectionarySidebar currentSlug="koodosh-eetho-to-kothne" />
            </div>
          </div>
