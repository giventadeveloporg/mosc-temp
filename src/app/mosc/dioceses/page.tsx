...
const DiocesesPage = () => {
  ...
  const dioceseCards = [
    ...
    { name: 'Diocese of Sulthan Bathery', href: '/mosc/dioceses/diocese-of-sulthan-bathery-diocese', excerpt: 'In 1986, the diocese of Sultan Bathery was formed by organising all the churches from the District of Wayanad, some of the churches from the Nilagiri District of Tamilnadu and some from Karnataka.', image: '/images/dioceses/sulthan_bathery_diocese.jpg' },
    { name: 'Diocese of Brahamavar', href: '/mosc/dioceses/diocese-of-brahamavar', excerpt: 'The Diocese of Brahmavar was formed in August 2010 and was announced by His Holiness Baselios Marthoma Didymus I through the Kalpana No.389/2010 dated 3-8-2010. The formation was with the goal of shepherding the faithful in the region.', image: '/images/dioceses/bhramavar_diocese.jpg' },
    { name: 'Diocese of Madras', href: '/mosc/dioceses/diocese-of-chennai-diocese', excerpt: 'Madras City, hallowed and blessed by the martyrdom of St. Thomas the Apostle, has been the Headquarters of the Madras Diocese belonging to the Orthodox Church of India for many decades.', image: '/images/dioceses/madras_diocese.jpg' },
    ...
    { name: 'Diocese of South West America', href: '/mosc/dioceses/diocese-of-south-west-america', excerpt: 'The Diocese was formed by order number 145/2009 signed by the then Catholicos of the Apostolic Throne of St. Thomas and Malankara Metropolitan, His Holiness Baselios Mar Thoma Didymos I.', image: '/images/dioceses/southwest_america_diocese.jpg' },
    ...
    { name: 'ASIA PACIFIC', href: '/mosc/dioceses/asia-pacific', excerpt: 'The Asia Pacific diocese serves the faithful in the Asia Pacific region with its office in Canberra, Australia.', image: '/images/dioceses/asia-pacific-diocese.webp' },
    { name: 'CANADA', href: '/mosc/dioceses/canada', excerpt: 'The Canada diocese serves the Malankara Orthodox Syrian Church community across Canada with its office in Hamilton, Ontario.', image: '/images/dioceses/canda-diocese.webp' }
  ];
