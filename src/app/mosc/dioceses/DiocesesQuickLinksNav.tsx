...
const links = [
  { href: '/mosc/holy-synod', label: 'Holy Synod', icon: <ChurchIcon /> },
  { href: '/mosc/ecumenical', label: 'Ecumenical Relations', icon: <GlobeIcon /> },
  { href: '/mosc/institutions', label: 'Institutions', icon: <BuildingIcon /> },
  { href: '/mosc/training', label: 'Training', icon: <AcademicIcon /> },
  { href: '/mosc/publications', label: 'Publications', icon: <BookIcon /> },
  { href: '/mosc/spiritual-organizations', label: 'Spiritual Organisations', icon: <HeartIcon /> },
  { href: '/mosc/theological-seminaries', label: 'Theological Seminaries', icon: <ChurchIcon /> },
  { href: '/mosc/lectionary', label: 'Lectionary', icon: <BookOpenIcon /> },
  { href: '/mosc/gallery', label: 'Gallery', icon: <PhotoIcon /> },
  { href: '/mosc/contact-info', label: 'Contact Info', icon: <MailIcon /> },
  { href: '/mosc/faqs', label: 'FAQs', icon: <QuestionIcon /> },
];
