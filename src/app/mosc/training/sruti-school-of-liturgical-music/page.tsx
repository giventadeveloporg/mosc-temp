          ...
          <div className="space-y-3 font-syro-primary text-syro-dark-gray">
            ...
            <p>
              ...
              <div className="mt-8 flex justify-center">
                <Link href="/mosc/training" className="inline-flex items-center px-6 py-3 bg-syro-red text-white font-syro-primary font-medium rounded-lg hover:bg-syro-red/90 transition-all duration-300 shadow-syro-card">
