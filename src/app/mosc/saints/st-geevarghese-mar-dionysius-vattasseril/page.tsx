            ...
            <div className="lg:col-span-3">
              <div className="bg-background rounded-lg sacred-shadow p-8">
                ...
                <div className="prose prose-lg max-w-none font-body text-muted-foreground leading-relaxed space-y-4">
                  <h2 className="font-heading font-semibold text-xl text-foreground">Introduction</h2>
                  <p>
                  ...
                  <h2 className="font-heading font-semibold text-xl text-foreground">Early Life</h2>
                  <p>
                  ...
                  <h2 className="font-heading font-semibold text-xl text-foreground">Life in the Church</h2>
                  <p>
                  ...
                  <h2 className="font-heading font-semibold text-xl text-foreground">Legacy</h2>
                  <p>
