              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-8">
                ...
                <div className="prose prose-lg max-w-none font-syro-primary text-syro-dark-gray leading-relaxed space-y-4">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-justify">
                    ...
                    <li>The Father, The Son and The Holy Spirit are of the same substance (á½Î¼Î¿Î¿Ï…ÏƒÎ¹Î¿Ï‚).</li>
                  </ul>
                  <p className="text-justify">
                  ...
                  <h3 className="font-syro-display font-medium text-lg text-syro-blue mt-8 mb-4">Related</h3>
                  <ul className="list-disc pl-6 space-y-2">
                    <li><Link href="/mosc/saints/other-saints-and-martyrs?from=saints" className="text-syro-blue hover:underline">Other Saints and Martyrs</Link></li>
                    <li><Link href="/mosc/saints/st-geevarghese-mar-dionysius-vattasseril?from=saints" className="text-syro-blue hover:underline">St. Geevarghese Mar Dionysius Vattasseril</Link></li>
                    <li><Link href="/mosc/saints/st-gregorios-of-parumala-metropolitan-geevarghese-mar-gregorios?from=saints" className="text-syro-blue hover:underline">St. Gregorios Of Parumala – Metropolitan Geevarghese Mar Gregorios</Link></li>
                    <li><Link href="/mosc/saints/st-baselios-yeldho-kothamangalam-bava?from=saints" className="text-syro-blue hover:underline">St. Baselios Yeldho (Kothamangalam Bava)</Link></li>
                    <li><Link href="/mosc/saints/early-church-father?from=saints" className="text-syro-blue hover:underline">Early Church Fathers</Link></li>
                    <li><Link href="/mosc/saints/the-apostles?from=saints" className="text-syro-blue hover:underline">The Apostles</Link></li>
                    <li><Link href="/mosc/saints/st-mary-mother-of-god?from=saints" className="text-syro-blue hover:underline">St. Mary Mother of God</Link></li>
                  </ul>
                </div>
              </div>
