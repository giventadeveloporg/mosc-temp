...
export const metadata = {
  ...
  description: 'His Grace Dr. Joshua Mar Nicodimos, Metropolitan of Ranniâ€“Nilackal Diocese. Superior, Holy Trinity Ashram, Angadi; President, Akhila Malankara Balasamajam; Doctor of Divinity (honoris causa), General Theological Seminary, New York.',
};
                ...
                <div>
                    ...
                    <div className="prose prose-lg max-w-none">
                      ...
                      <div className="font-syro-primary text-syro-dark-gray leading-relaxed space-y-1">
                        <p>Nilackal Orthodox Diocesan Centre, St. Thomas Aramana, Pazhavangadi P.O., Ranni, Pathanamthitta â€“ 689 673</p>
                        <p>Mobile: 9446600671</p>
                        <p>Email: marnicodimos@gmail.com</p>
                      </div>
                    </div>
                </div>
              </div>
