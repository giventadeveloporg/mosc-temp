...
export const metadata = {
  ...
  description: 'What do the Orthodox believe? Our trust is in the One True Godâ€”Father, Son and Holy Spirit. The faith of the Malankara Orthodox Syrian Church.',
};
