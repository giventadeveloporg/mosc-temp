...
const OrientalAndEasternOrthodoxChurchesPage = () => {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              How different is the Eastern Orthodox Church? Who are these Orthodox—Protestants or
              Roman Catholics? What do they believe differently? We belong to the Oriental Orthodox
              family of churches.
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-background rounded-lg sacred-shadow p-8">
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <ul className="list-disc list-inside font-body text-muted-foreground leading-relaxed mb-6 space-y-2 pl-2">
...
export default OrientalAndEasternOrthodoxChurchesPage;
