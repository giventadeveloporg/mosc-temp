...
const THE_CHURCH_LINKS: SidebarItem[] = [
  ...
  { href: '/mosc/the-church/oriental-and-eastern-orthodox-churches', label: 'Oriental and Eastern Orthodox churches' },
  {
    ...
    children: [
      ...
      { href: '/mosc/the-church/church-history/after-1653-as-an-independent-church', label: 'After 1653 as an independent Church' },
      { href: '/mosc/the-church/church-history/the-orthodox-from-the-19th-century', label: 'The Orthodox from the 19th century' },
      { href: '/mosc/the-church/church-history/connection-with-the-syrian-churches', label: 'Connection with the Syrian churches' },
