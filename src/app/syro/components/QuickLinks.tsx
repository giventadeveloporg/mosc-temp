...
const quickLinks: QuickLink[] = [
  { name: 'Kalpana', href: '/syro/downloads/kalpana', icon: <DocumentIcon /> },
  { name: 'Downloads', href: '/syro/downloads', icon: <DownloadIcon /> },
  { name: 'Institutions', href: '/syro/institutions', icon: <BuildingIcon /> },
  { name: 'Training', href: '/syro/training', icon: <AcademicIcon /> },
  { name: 'Publications', href: '/syro/publications', icon: <BookIcon /> },
  { name: 'Directory', href: '/syro/directory', icon: <DirectoryIcon /> },
  { name: 'Spiritual Organisations', href: '/syro/spiritual-organizations', icon: <HeartIcon /> },
  { name: 'Theological Seminaries', href: '/syro/theological-seminaries', icon: <ChurchIcon /> },
  { name: 'Calendar', href: '/syro/calendar', icon: <CalendarIcon /> },
  { name: 'Lectionary', href: '/syro/lectionary', icon: <BookOpenIcon /> },
  { name: 'News & Events', href: 'https://www.facebook.com/catholicatenews.in', icon: <NewspaperIcon />, external: true },
  { name: 'Online Resources', href: '/syro/online-resources', icon: <GlobeIcon /> },
  { name: 'Gallery', href: '/syro/gallery', icon: <PhotoIcon /> },
  { name: 'Contact Info', href: '/syro/contact-info', icon: <MailIcon /> },
  { name: 'FAQs', href: '/syro/faqs', icon: <QuestionIcon /> }
];
