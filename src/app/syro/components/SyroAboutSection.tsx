              ...
              <div className="row position-relative">
                <div className="col-6 about-img-1">
                  <div className="img-1-container">
                    <Image
                      id="about_image_1"
                      src="/syro/assets/images/mosc_images/Cross_Image.png"
                      alt=""
                      width={280}
                      height={380}
                ...
                <div className="col-6">
                  <Image
                    id="about_image_2"
                    src="/syro/assets/images/mosc_images/Malankara_Orthodox_Fathers_Image.jpeg"
                  ...
                  <Image
                    id="about_image_3"
                    src="/syro/assets/images/mosc_images/MOSC_Cross_Inside_Circle.png"
                    alt=""
                    width={350}
                    height={200}
