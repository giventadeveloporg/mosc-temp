...
const HERO_IMAGES = [
  { src: '/syro/assets/images/mosc_images/bava_thirumeni_pope_visit.jpeg', alt: 'Malankara Orthodox Syrian Church' },
  { src: '/syro/assets/images/mosc_images/Malankara_Orthodox_Palace_Slider_New.jpeg', alt: 'Malankara Orthodox Palace' },
];
