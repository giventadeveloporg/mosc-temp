...
const ResourcesServicesSection = () => {
  const resourceCards = [
    { name: 'Liturgical Calendar', icon: 'calendar', href: '/syro/calendar' },
    { name: 'Lectionary', icon: 'book', href: '/syro/lectionary' },
    { name: 'Parish Directory', icon: 'map', href: '/syro/directory' },
    { name: 'Prayer Requests', icon: 'prayer', href: '/syro/contact-form-email' },
    { name: 'Publications', icon: 'document', href: '/syro/publications' },
    { name: 'Youth Ministry', icon: 'people', href: '/syro/training' },
    { name: 'Media Gallery', icon: 'gallery', href: '/syro/gallery' },
    { name: 'Contact Us', icon: 'phone', href: '/syro/contact-info' },
  ];
