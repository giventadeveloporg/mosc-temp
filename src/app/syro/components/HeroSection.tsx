          ...
          <div className="flex flex-col items-center justify-start order-2 md:order-1">
            ...
            <div className="mt-4 text-center md:text-left">
              ...
              <nav className="flex items-center justify-center md:justify-start gap-x-2 text-sm lg:text-[15px] font-syro-primary">
                <Link href="/syro/holy-synod/his-holiness-baselios-marthoma-mathews-iii" className="font-semibold text-syro-blue hover:text-syro-red transition-colors duration-200">
                  Biography
                </Link>
                <span className="text-syro-blue font-semibold">|</span>
                <Link href="/syro/photo-gallery/reception-to-his-holiness-baselios-marthoma-mathews-iii" className="font-semibold text-syro-blue hover:text-syro-red transition-colors duration-200">
                  Photos
                </Link>
                <span className="text-syro-blue font-semibold">|</span>
                <Link href="/syro/speeches" className="font-semibold text-syro-blue hover:text-syro-red transition-colors duration-200">
                  Speeches
                </Link>
              </nav>
            </div>
