...
const currentSlug = '/mosc/saints/st-geevarghese-mar-dionysius-vattasseril';

export default function StGeevargheseMarDionysiusPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-primary text-lg text-syro-dark-gray max-w-3xl mx-auto leading-relaxed">
              Malankara Metropolitan and champion of Church freedom
            </p>
          </div>
        </div>
      </section>
