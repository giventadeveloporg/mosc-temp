...
const currentSlug = '/syro/saints/st-gregorios-of-parumala-metropolitan-geevarghese-mar-gregorios';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-8">
                ...
                <div className="prose prose-lg max-w-none font-syro-primary text-syro-dark-gray leading-relaxed space-y-4">
                  ...
                  <h2 className="font-syro-display font-semibold text-xl text-syro-blue pt-4">READER-DEACON AND FURTHER EDUCATION</h2>
                  <p>
                  ...
                  <h2 className="font-syro-display font-semibold text-xl text-syro-blue pt-4">PATRIARCHAL VISIT AND THE SYNOD OF MULAMTHURUTHY</h2>
                  <p>
                  ...
                  <h2 className="font-syro-display font-semibold text-xl text-syro-blue pt-4">CONSECRATION AS METROPOLITAN</h2>
                  <p>
                  ...
                  <h2 className="font-syro-display font-semibold text-xl text-syro-blue pt-4">A VISION AND MISSION FOR THE ENTIRE CHURCH</h2>
                  <p>
            ...
            <div className="lg:col-span-1">
                  ...
                  {SAINTS_SIDEBAR_LINKS.map((link) => (
                    <Link
                      ...
                      className={`block px-3 py-2 rounded-md font-syro-primary text-sm transition-all duration-300 ${
                        link.href === currentSlug ? 'bg-syro-red text-white' : 'text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray'
                      }`}
                    >
                      {link.label}
                    </Link>
              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                ...
                <nav className="space-y-2">
                  <Link href="/syro/the-church" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">The Church</Link>
                  <Link href="/syro/holy-synod" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">Holy Synod</Link>
                  <Link href="/syro/dioceses" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">Dioceses</Link>
                  <Link href="/syro/ecumenical" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">Ecumenical Relations</Link>
                  <Link href="/syro/institutions" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">Institutions</Link>
                  <Link href="/syro/gallery" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">Gallery</Link>
                  <Link href="/syro/contact-info" className="block px-3 py-2 text-syro-dark-gray hover:text-syro-red hover:bg-syro-bg-gray rounded-md font-syro-primary text-sm transition-all duration-300">Contact Info</Link>
                </nav>
              </div>
            </div>
          </div>
