      ...
      <section className="bg-syro-bg-gray py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 font-syro-primary text-sm text-syro-dark-gray">
            ...
            <span>/</span>
            <Link href="/syro/downloads" className="hover:text-syro-red transition-all duration-300">Downloads</Link>
            <span>/</span>
            <span className="text-syro-blue">PDFs & Documents</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-12 bg-syro-bg-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center">
            <Link href="/syro/downloads" className="inline-flex items-center px-6 py-3 bg-syro-red text-syro-red-foreground font-syro-primary font-medium rounded-lg hover:bg-syro-red/90 transition-all duration-300 shadow-syro-card">
