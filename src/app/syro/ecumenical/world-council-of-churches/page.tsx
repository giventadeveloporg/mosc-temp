...
const worldcouncilofchurchesPage = () => {
  return (
    <div className="bg-syro-bg-gray">
      ...
      <section className="hidden py-16 bg-gradient-to-br from-syro-bg-gray to-syro-bg-gray" aria-hidden>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="w-20 h-20 bg-syro-red rounded-lg flex items-center justify-center mx-auto mb-6 shadow-syro-card-hover">
              <span className="text-syro-red-foreground text-4xl font-bold" role="img" aria-label="World Council of Churches">🌍</span>
            </div>
