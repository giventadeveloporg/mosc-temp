    ...
    <div className="min-h-screen bg-syro-bg-gray">
      <section className="relative bg-syro-bg-gray py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/syro/directory/parishes" className="font-body text-syro-blue hover:underline mb-4 inline-block">← Parishes</Link>
      ...
      <section className="py-12 bg-syro-bg-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8">
            <Link href="/syro/directory/parishes" className="font-body text-syro-blue font-medium hover:underline">← Back to Parishes</Link>
          </div>
        </div>
      </section>
    </div>
