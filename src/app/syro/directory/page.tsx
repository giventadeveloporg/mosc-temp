...
export const metadata: Metadata = {
  title: 'Directory | Syro-Malabar Church',
  description: 'Access the comprehensive directory of the Syro-Malabar Church including parishes, priests, dioceses, and church officials.',
  keywords: ['Syro-Malabar Directory', 'Parish Directory', 'Priest Directory', 'Church Directory', 'Orthodox Church Contact'],
};
    ...
    <div className="min-h-screen bg-syro-bg-gray">
      ...
      <section className="relative bg-gradient-to-br from-white to-syro-light-gray py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-primary text-syro-body lg:text-[1.25rem] text-syro-text-gray max-w-3xl mx-auto mb-8">
              Access the comprehensive directory of the Syro-Malabar Church including parishes, priests, dioceses, and church officials.
            </p>
            <a
              href="/syro/directory"
              className="inline-flex items-center px-8 py-4 bg-syro-red text-white font-syro-primary font-semibold text-syro-h4 rounded-[5px] hover:bg-syro-red-darker transition-all duration-300 shadow-syro-card hover:shadow-syro-card-hover"
            >
      ...
      <section className="py-16 bg-syro-light-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-[5px] shadow-syro-card p-8">
            <h2 className="font-syro-display font-semibold text-syro-h3 text-syro-blue mb-6 text-center">
              How to Use the Directory
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-syro-red-light rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="font-syro-display font-bold text-syro-h4 text-syro-red">1</span>
                </div>
                <h3 className="font-syro-display font-medium text-syro-h4 text-syro-blue mb-2">
                  Search
                </h3>
              ...
              <div className="text-center">
                <div className="w-12 h-12 bg-syro-red-light rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="font-syro-display font-bold text-syro-h4 text-syro-red">2</span>
                </div>
                <h3 className="font-syro-display font-medium text-syro-h4 text-syro-blue mb-2">
                  Browse
                </h3>
              ...
              <div className="text-center">
                <div className="w-12 h-12 bg-syro-red-light rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="font-syro-display font-bold text-syro-h4 text-syro-red">3</span>
                </div>
                <h3 className="font-syro-display font-medium text-syro-h4 text-syro-blue mb-2">
                  Connect
                </h3>
      ...
      <section className="py-16 bg-syro-red-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-[5px] shadow-syro-card p-12">
            ...
            <p className="font-syro-primary text-syro-body text-syro-text-gray leading-relaxed mb-8">
              The official directory is maintained on a dedicated platform for easy searching and regular updates. Click below to access the complete, searchable directory of the Syro-Malabar Church.
            </p>
            <a
              href="/syro/directory"
              className="inline-flex items-center px-8 py-4 bg-syro-red text-white font-syro-primary font-semibold text-syro-h4 rounded-[5px] hover:bg-syro-red-darker transition-all duration-300 shadow-syro-card hover:shadow-syro-card-hover"
            ...
            <p className="font-syro-primary text-syro-small text-syro-text-gray mt-4">
              (Opens in new window)
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-syro-light-gray/30 rounded-[5px] p-8 shadow-syro-card border-l-4 border-syro-red">
              <h3 className="font-syro-display font-semibold text-syro-h3 text-syro-blue mb-4">
                Catholicate Palace, Devalokam
              </h3>
              <div className="space-y-3 font-syro-primary text-syro-text-gray">
                ...
                <p className="flex items-start">
                  ...
                  <a href="mailto:catholicos@mosc.in" className="text-syro-red hover:underline">
                    catholicos@mosc.in
                  </a>
                </p>
              </div>
            ...
            <div className="bg-syro-light-gray/30 rounded-[5px] p-8 shadow-syro-card border-l-4 border-syro-red">
              ...
              <div className="space-y-3 font-syro-primary text-syro-text-gray">
                <p className="flex items-start">
                  ...
                  <a href="mailto:pro@mosc.in" className="text-syro-red hover:underline">
                    pro@mosc.in
                  </a>
                </p>
                <p className="mt-6 text-syro-small">
      ...
      <section className="py-16 bg-syro-light-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link
              href="/syro/dioceses"
              className="bg-white rounded-[5px] p-6 shadow-syro-card hover:shadow-syro-card-hover transition-all duration-500 text-center group"
            >
              <div className="w-12 h-12 bg-syro-red-light rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-syro-red/20 transition-all duration-300">
                <svg className="w-6 h-6 text-syro-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                </svg>
              </div>
              <h3 className="font-syro-display font-medium text-syro-h4 text-syro-blue mb-2 group-hover:text-syro-red transition-colors duration-300">
                Dioceses
              </h3>
              <p className="font-syro-primary text-syro-small text-syro-text-gray">
