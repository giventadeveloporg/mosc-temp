      ...
      <section className="bg-syro-bg-gray py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 font-syro-primary text-sm text-syro-dark-gray">
            <Link href="/mosc" className="hover:text-syro-red transition-all duration-300">
              MOSC
            </Link>
            <span>/</span>
            <Link href="/syro/lectionary" className="hover:text-syro-red transition-all duration-300">
              Lectionary
            </Link>
            <span>/</span>
            <span className="text-syro-blue">Kyomtho (Easter) to Koodosh Edtho</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-12 bg-syro-bg-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <Link
              href="/syro/lectionary/great-lent"
            ...
            <Link
              href="/syro/lectionary/special-occasions"
