...
export const metadata: Metadata = {
  title: 'Lectionary | Syro-Malabar Church',
  description: 'The liturgical lectionary of the Syro-Malabar Church, including scripture readings for the church year from Koodosh Eetho to Special Occasions.',
  ...
  const lectionaryPeriods = [
    {
      ...
      link: '/syro/lectionary/koodosh-eetho-to-kothne',
    },
    {
      id: 'great-lent',
      title: 'Great Lent',
      ...
      link: '/syro/lectionary/great-lent',
    },
    {
      ...
      link: '/syro/lectionary/kyomtho-easter-to-koodosh-edtho',
    },
    {
      ...
      link: '/syro/lectionary/special-occasions',
    },
  ];
    ...
    <div className="min-h-screen bg-syro-bg-gray">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-body text-lg lg:text-xl text-syro-text-gray max-w-3xl mx-auto">
              The liturgical lectionary of the Syro-Malabar Church, guiding our community through the sacred scriptures throughout the church year.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {lectionaryPeriods.map((period) => (
              <Link
                key={period.id}
                href={period.link}
                className="group bg-white rounded-[5px] shadow-syro-card hover:shadow-syro-card-lg transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="p-6">
                  <h2 className="font-syro-display font-semibold text-2xl text-syro-blue mb-3 group-hover:text-syro-red transition-colors duration-300">
                    {period.title}
                  </h2>
                  <p className="font-syro-body text-syro-text-gray leading-relaxed mb-4 line-clamp-3">
                    {period.description}
                  </p>
                  <span className="inline-flex items-center font-syro-body text-syro-red font-medium group-hover:gap-2 transition-all duration-300">
                    View Readings
                    <svg 
      ...
      <section className="py-16 bg-syro-light-gray">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-syro-body text-lg text-syro-text-gray leading-relaxed mb-6">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="font-syro-body text-lg text-syro-text-gray max-w-3xl mx-auto">
