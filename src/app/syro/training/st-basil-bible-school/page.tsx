  ...
  return (
    <div className="min-h-screen bg-syro-bg-gray">
      ...
      <section className="bg-syro-bg-gray py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 font-syro-primary text-sm text-syro-dark-gray">
            <Link href="/mosc" className="hover:text-syro-red transition-all duration-300">MOSC</Link>
            <span>/</span>
            <Link href="/syro/training" className="hover:text-syro-red transition-all duration-300">Training</Link>
            <span>/</span>
            <span className="text-syro-blue">St. Basil Bible School</span>
          </nav>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-syro-display text-xl text-syro-red mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 font-syro-primary text-lg text-syro-dark-gray leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-muted to-background rounded-lg p-8 shadow-syro-card">
      ...
      <section className="py-16 bg-syro-bg-gray">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-syro-card-sm text-center">
              <div className="w-12 h-12 bg-syro-red/10 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-syro-red/5 rounded-lg shadow-syro-card p-8 border-l-4 border-primary">
            <h3 className="font-syro-display font-semibold text-2xl text-syro-blue mb-6">
              Contact Information
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-syro-display font-medium text-lg text-syro-blue mb-3">Address</h4>
                <div className="space-y-2 font-syro-primary text-syro-dark-gray">
                  ...
                  <p>India-690520</p>
                  <p className="pt-3">
                    <span className="font-medium text-syro-blue">Phone:</span> 0476-2831712 (Bible School)
                  </p>
                </div>
              </div>
              <div>
                <h4 className="font-syro-display font-medium text-lg text-syro-blue mb-3">Contact Persons</h4>
                <div className="space-y-4 font-syro-primary text-syro-dark-gray">
      ...
      <section className="py-12 bg-syro-bg-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center">
            <Link href="/syro/training" className="inline-flex items-center px-6 py-3 bg-syro-red text-syro-red-foreground font-syro-primary font-medium rounded-lg hover:bg-syro-red/90 transition-all duration-300 shadow-syro-card">
