...
export const metadata: Metadata = {
  title: 'Calendar | Syro-Malabar Church',
  description: 'Access the liturgical calendar of the Syro-Malabar Church with feast days, fasts, and important church dates.',
  keywords: ['Syro-Malabar Calendar', 'Liturgical Calendar', 'Orthodox Feast Days', 'Church Calendar', 'Fasting Days'],
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-primary text-syro-body lg:text-[1.25rem] text-syro-text-gray max-w-3xl mx-auto mb-8">
              Access the complete liturgical calendar of the Syro-Malabar Church with feast days, fasting periods, and important church observances.
            </p>
            <a
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-syro-light-gray/30 rounded-[5px] p-6 shadow-syro-card border-l-4 border-syro-red">
              <h3 className="font-syro-display font-semibold text-syro-h3 text-syro-blue mb-3">
