...
const THE_CHURCH_LINKS: SidebarItem[] = [
  ...
  { href: '/syro/the-church/orthodox-faith', label: 'Orthodox Faith' },
  {
    ...
    children: [
      ...
      { href: '/syro/the-church/spirituality/shubqono-let-us-be-reconciled-with-one-another', label: 'Shubqono' },
    ],
  },
  ...
  { href: '/syro/the-church/oriental-and-eastern-orthodox-churches', label: 'Oriental and Eastern Orthodox churches' },
  {
    ...
    children: [
      ...
      { href: '/syro/the-church/church-history/after-1653-as-an-independent-church', label: 'After 1653 as an independent Church' },
      { href: '/syro/the-church/church-history/the-orthodox-from-the-19th-century', label: 'The Orthodox from the 19th century' },
      { href: '/syro/the-church/church-history/connection-with-the-syrian-churches', label: 'Connection with the Syrian churches' },
  ...
  { href: '/syro/the-church/the-holy-myron', label: 'The Holy Myron' },
  {
    ...
    label: 'Liturgy',
    children: [
      { href: '/syro/the-church/liturgy/liturgy-and-spiritual-practices', label: 'Liturgy and Spiritual Practices' },
      { href: '/syro/the-church/liturgy/west-syrian-worship', label: 'West Syrian Worship' },
      { href: '/syro/the-church/liturgy/feast-and-festivals', label: 'Feast and Festivals' },
      { href: '/syro/the-church/liturgy/holy-qurbana', label: 'Holy Qurbana' },
      { href: '/syro/the-church/liturgy/liturgical-music', label: 'Liturgical Music' },
      { href: '/syro/the-church/liturgy/liturgical-year-seasons', label: 'Liturgical Year & Seasons' },
      { href: '/syro/the-church/liturgy/sacraments', label: 'Sacraments' },
    ],
  },
