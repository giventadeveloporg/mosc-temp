...
const FastingAndAbstinencePage = () => {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-primary text-lg text-syro-dark-gray max-w-3xl mx-auto leading-relaxed">
              Fasting in the Malankara Orthodox Syrian tradition. Following the example of Christ
              and the apostolic community—a feast of the soul and a weapon against the evil one.
            </p>
          </div>
        </div>
      </section>
...
export default FastingAndAbstinencePage;
