        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-primary text-lg text-syro-dark-gray max-w-3xl mx-auto leading-relaxed">
              The cultivation of the Christian life. Life over mission, community over individualism,
              creation in its totality, and death, resurrection, and the last judgment.
            </p>
          </div>
        </div>
      </section>
...
export default TheChristianLifePage;
