        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="font-syro-primary text-lg text-syro-dark-gray max-w-3xl mx-auto leading-relaxed">
              Deification (theosis) as the goal of spirituality. Becoming like God through communion
              with Christ and the Holy Spirit, in tune with the Orthodox tradition and Indian spirituality.
            </p>
          </div>
        </div>
      </section>
...
export default DeificationPage;
