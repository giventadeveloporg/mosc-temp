            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,rgba(0,0,0,0.3)_0px_3px_7px_-3px] p-8 mb-8">
                ...
                <div className="mb-8 flex justify-center">
                  <Image
                    src="https://mosc.in/wp-content/uploads/2014/12/Untitled-12.jpg"
                ...
                <div className="mt-3 space-y-1.5">
                  {SYRO_CATHOLICOS_LINKS.map((catholicos) => (
                    <Link
                      ...
                      className={`block p-2 rounded-lg hover:bg-syro-bg-gray/50 transition-colors group leading-tight ${catholicos.href === '/syro/catholicate/his-holiness-baselios-geevarghese-i-second-catholicos-of-the-east-in-malankara' ? 'bg-syro-blue/5 border border-syro-blue/20' : ''}`}
                    >
