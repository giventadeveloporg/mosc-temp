                ...
                <div className="space-y-3">
                  {catholicosLinks.map((catholicos, index) => (
                    <Link
                      ...
                      className={`block p-3 rounded-lg hover:bg-syro-bg-gray/50 transition-all duration-300 group ${index === 2 ? 'bg-syro-red/5 border border-primary/20' : ''}`}
                    >
              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-syro-dark-gray">1870</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Consecrated as Bishop:</span>
                    <p className="text-sm text-syro-dark-gray">30 April 1925</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Reign:</span>
                    <p className="text-sm text-syro-dark-gray">1925–1928</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Passed Away:</span>
                    <p className="text-sm text-syro-dark-gray">17 December 1928</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Resting Place:</span>
                    <p className="text-sm text-syro-dark-gray">Northern side of Vallikattu Dayara</p>
                  </div>
                </div>
              </div>
            </div>
