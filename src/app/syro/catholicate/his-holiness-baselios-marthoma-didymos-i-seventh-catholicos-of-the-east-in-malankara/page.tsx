                ...
                <div className="space-y-3">
                  {catholicosLinks.map((catholicos, index) => (
                    <Link
                      ...
                      className={`block p-3 rounded-lg hover:bg-syro-bg-gray/50 transition-all duration-300 group ${index === 7 ? 'bg-syro-red/5 border border-primary/20' : ''}`}
                    >
              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-syro-dark-gray">29 October 1921</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Consecrated as Bishop:</span>
                    <p className="text-sm text-syro-dark-gray">24 August 1966 (Thomas Mar Timotheos)</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Reign:</span>
                    <p className="text-sm text-syro-dark-gray">2005–2010</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Passed Away:</span>
                    <p className="text-sm text-syro-dark-gray">26 May 2014</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Resting Place:</span>
                    <p className="text-sm text-syro-dark-gray">Mount Tabor Dayara, Pathanapuram</p>
                  </div>
                </div>
              </div>
            </div>
