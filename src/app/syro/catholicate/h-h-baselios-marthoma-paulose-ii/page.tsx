                ...
                <div className="mt-3 space-y-1.5">
                  {SYRO_CATHOLICATE_SIDEBAR_LINKS.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className={`block p-2 rounded-lg hover:bg-syro-bg-gray/50 transition-colors group leading-tight ${item.href === '/syro/catholicate/h-h-baselios-marthoma-paulose-ii' ? 'bg-syro-blue/5 border border-syro-blue/20' : ''}`}
                    >
