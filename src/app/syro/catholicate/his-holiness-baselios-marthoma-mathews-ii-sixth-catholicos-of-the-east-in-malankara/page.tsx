                ...
                <div className="space-y-3">
                  {catholicosLinks.map((catholicos, index) => (
                    <Link
                      ...
                      className={`block p-3 rounded-lg hover:bg-syro-bg-gray/50 transition-all duration-300 group ${index === 6 ? 'bg-syro-red/5 border border-primary/20' : ''}`}
                    >
              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-syro-dark-gray">30 January 1915</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Consecrated as Bishop:</span>
                    <p className="text-sm text-syro-dark-gray">15 May 1953</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Reign:</span>
                    <p className="text-sm text-syro-dark-gray">1991–2005</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Passed Away:</span>
                    <p className="text-sm text-syro-dark-gray">26 January 2006</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Resting Place:</span>
                    <p className="text-sm text-syro-dark-gray">Mar Elia Chapel, Shastamcotta</p>
                  </div>
                </div>
              </div>
            </div>
