          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-8">
                ...
                <div className="space-y-8 font-syro-primary text-syro-dark-gray leading-relaxed">
                  {/* Introduction */}
                  <div>
                    <h2 className="font-syro-display font-semibold text-2xl text-syro-red mb-4">Introduction</h2>
                    <p>
                  ...
                  <div>
                    <h2 className="font-syro-display font-semibold text-2xl text-syro-red mb-6">Historical Development of Catholicate in India</h2>
            ...
            <div className="space-y-6">
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                <h3 className="font-syro-display font-semibold text-xl text-syro-blue mb-4">The Catholicate of the Malankara Orthodox Syrian Church</h3>
                <div className="space-y-3">
                  {catholicosLinks.map((catholicos, index) => (
                    <Link
                      key={catholicos.name}
                      href={catholicos.href}
                      className={`block p-3 rounded-lg hover:bg-syro-bg-gray/50 transition-all duration-300 group ${index === 0 ? 'bg-syro-red/5 border border-primary/20' : ''}`}
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {catholicos.period && <p className="font-syro-primary text-xs text-syro-red font-medium">{catholicos.period}</p>}
                          {catholicos.description && <p className="font-syro-primary text-xs text-syro-dark-gray">{catholicos.description}</p>}
                        </div>
                      </div>
                    </Link>
                  ))}
