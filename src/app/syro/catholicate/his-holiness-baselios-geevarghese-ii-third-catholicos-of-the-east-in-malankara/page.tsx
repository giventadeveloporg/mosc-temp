                ...
                <div className="space-y-3">
                  {catholicosLinks.map((catholicos, index) => (
                    <Link
                      ...
                      className={`block p-3 rounded-lg hover:bg-syro-bg-gray/50 transition-all duration-300 group ${index === 3 ? 'bg-syro-red/5 border border-primary/20' : ''}`}
                    >
              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-syro-dark-gray">16 June 1874</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Consecrated as Bishop:</span>
                    <p className="text-sm text-syro-dark-gray">8 September 1912</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Reign:</span>
                    <p className="text-sm text-syro-dark-gray">1929–1964</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Passed Away:</span>
                    <p className="text-sm text-syro-dark-gray">3 January 1964</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Resting Place:</span>
                    <p className="text-sm text-syro-dark-gray">Beside Devalokam Aramana Chapel</p>
                  </div>
                </div>
              </div>
            </div>
