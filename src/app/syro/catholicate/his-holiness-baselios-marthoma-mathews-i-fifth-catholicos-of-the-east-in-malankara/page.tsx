                ...
                <div className="space-y-3">
                  {catholicosLinks.map((catholicos, index) => (
                    <Link
                      ...
                      className={`block p-3 rounded-lg hover:bg-syro-bg-gray/50 transition-all duration-300 group ${index === 5 ? 'bg-syro-red/5 border border-primary/20' : ''}`}
                    >
              ...
              <div className="bg-syro-bg-gray rounded-lg shadow-syro-card p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-syro-dark-gray">27 March 1907</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Consecrated as Bishop:</span>
                    <p className="text-sm text-syro-dark-gray">21 September 1951 (Mathews Mar Athanasios)</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Reign:</span>
                    <p className="text-sm text-syro-dark-gray">1975–1991</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Passed Away:</span>
                    <p className="text-sm text-syro-dark-gray">8 November 1996</p>
                  </div>
                  <div>
                    <span className="font-medium text-syro-blue">Resting Place:</span>
                    <p className="text-sm text-syro-dark-gray">Devalokam Aramana</p>
                  </div>
                </div>
              </div>
            </div>
