                ...
                <div className="mt-3 space-y-1.5">
                  {SYRO_CATHOLICOS_LINKS.map((catholicos) => (
                    <Link
                      ...
                      className={`block p-2 rounded-lg hover:bg-syro-bg-gray/50 transition-colors group leading-tight ${catholicos.href === '/syro/catholicate/his-holiness-baselios-marthoma-mathews-i-fifth-catholicos-of-the-east-in-malankara' ? 'bg-syro-blue/5 border border-syro-blue/20' : ''}`}
                    >
