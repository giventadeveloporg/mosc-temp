...
import { FaEdit, FaTrashAlt, FaUsers, FaPhotoVideo, FaCalendarAlt, FaTimes, FaTicketAlt, FaTags, FaHome } from 'react-icons/fa';
          ...
          <div className="text-center">
            ...
            <div className="mt-6 flex flex-row gap-3 sm:gap-4 justify-center">
              ...
              <button
                ...
                className="flex-1 flex-shrink-0 h-14 rounded-xl bg-red-100 hover:bg-red-200 flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 px-6 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                disabled={isPending}
