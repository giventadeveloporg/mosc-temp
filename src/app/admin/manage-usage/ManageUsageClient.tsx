            ...
            {totalUsers > 0 ? (
              <div className="inline-flex items-center px-4 py-2 bg-blue-50 border-2 border-blue-300 rounded-lg shadow-sm">
                <span className="text-sm text-gray-700">
                  Showing <span className="font-bold text-blue-600">{startEntry}</span> to <span className="font-bold text-blue-600">{endEntry}</span> of <span className="font-bold text-blue-600">{totalUsers}</span> results
                </span>
              </div>
            ) : (
