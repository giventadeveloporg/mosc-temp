...
export const metadata: Metadata = {
  title: 'Reception to His Holiness Baselios Marthoma Mathews III | Photo Gallery | MOSC',
  description: 'Photo gallery of Reception to His Holiness Baselios Marthoma Mathews III, The Ninth Catholicos of the East in Malankara.',
};

export default function ReceptionToHisHolinessBaseliosMarthomaMathewsIiiPage() {
  const photos = [
