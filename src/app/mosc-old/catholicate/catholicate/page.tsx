          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="bg-background rounded-lg sacred-shadow p-8">
                <div className="mb-8 flex justify-center">
                  <Image
                    ...
                    alt="The Catholicate of theMalankara Orthodox Syrian Church"
                    width={500}
                    height={300}
                    className="mb-6 w-full max-w-md h-auto"
                    priority
                  />
                </div>
                ...
                <div className="space-y-8 font-body text-muted-foreground leading-relaxed">
                  {/* Introduction */}
                  <div>
                    <h2 className="font-heading font-semibold text-2xl text-primary mb-4">Introduction</h2>
                    <p>
                  ...
                  <div>
                    <h2 className="font-heading font-semibold text-2xl text-primary mb-6">Historical Development of Catholicate in India</h2>

                    <h3 className="font-heading font-semibold text-xl text-foreground mb-3">Archdeacons</h3>
                    <p>
                    ...
                    <h3 className="font-heading font-semibold text-xl text-foreground mb-3 mt-6">The Archdeacon as Bishop</h3>
                    <p>
                    ...
                    <h3 className="font-heading font-semibold text-xl text-foreground mb-3 mt-6">Malankara Metropolitan</h3>
                    <p>
                    ...
                    <h3 className="font-heading font-semibold text-xl text-foreground mb-3 mt-6">The way to Catholicate</h3>
                    <p>
                    ...
                    <h3 className="font-heading font-semibold text-xl text-foreground mb-3 mt-6">The consecration of the Catholicose</h3>
                    <p>
                    ...
                    <h3 className="font-heading font-semibold text-xl text-foreground mb-3 mt-6">Conclusion</h3>
                    <p>
            ...
            <div className="space-y-6">
              <div className="bg-background rounded-lg sacred-shadow p-6">
                <h3 className="font-heading font-semibold text-xl text-foreground mb-4">The Catholicate of the Malankara Orthodox Syrian Church</h3>
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {catholicos.period && <p className="font-body text-xs text-primary font-medium">{catholicos.period}</p>}
                          {catholicos.description && <p className="font-body text-xs text-muted-foreground">{catholicos.description}</p>}
                        </div>
                      </div>
                    </Link>
                  ))}
