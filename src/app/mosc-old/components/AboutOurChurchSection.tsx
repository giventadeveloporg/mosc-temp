...
const AboutOurChurchSection = () => {
  ...
  const mainNavigationLinks = [
    { label: 'THE CATHOLICATE', href: '/mosc-old/catholicate', icon: 'Crown', isInternal: true },
    { label: 'ADMINISTRATION', href: '/mosc-old/administration', icon: 'Building', isInternal: true },
    { label: 'THE CHURCH', href: '/mosc-old/the-church', icon: 'Church', isInternal: true },
    { label: 'HOLY SYNOD', href: '/mosc-old/holy-synod', icon: 'Users', isInternal: true },
    { label: 'ECUMENICAL', href: '/mosc-old/ecumenical', icon: 'Globe', isInternal: true },
    { label: 'DIOCESES', href: '/mosc-old/dioceses', icon: 'MapPin', isInternal: true },
    { label: 'SAINTS', href: '/mosc-old/saints', icon: 'Star', isInternal: true }
  ];

  const quickLinks = [
    { label: 'Spiritual Organisations', href: '/mosc-old/spiritual-organizations', icon: 'Cross', isInternal: true },
    { label: 'Theological Seminaries', href: '/mosc-old/theological-seminaries', icon: 'GraduationCap', isInternal: true },
    { label: 'Publications', href: '/mosc-old/publications', icon: 'BookOpen', isInternal: true },
    { label: 'Lectionary', href: '/mosc-old/lectionary', icon: 'BookOpen', isInternal: true },
    { label: 'Institutions', href: '/mosc-old/institutions', icon: 'Building', isInternal: true },
    { label: 'Downloads', href: '/mosc-old/downloads', icon: 'Download', isInternal: true },
    { label: 'Directory', href: '/mosc-old/directory', icon: 'Users', isInternal: true },
    { label: 'Calendar', href: '/mosc-old/calendar', icon: 'Calendar', isInternal: true },
    { label: 'Training', href: '/mosc-old/training', icon: 'GraduationCap', isInternal: true },
    { label: 'Gallery', href: '/mosc-old/gallery', icon: 'Image', isInternal: true }
  ];

  const specialLinks = [
    { label: 'SITEMAP', href: '/mosc-old/sitemap', icon: 'Map' },
    { label: 'APPS', href: '/mosc-old/apps', icon: 'Smartphone', external: true }
  ];
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6">
              ...
              <div className="bg-card rounded-lg sacred-shadow p-6">
                ...
                <button
                  onClick={() => handleLinkClick({ href: '/mosc-old/kalpana', label: 'DOWNLOAD' })}
              ...
              <div className="bg-card rounded-lg sacred-shadow p-6">
                <div className="space-y-3">
                  <button
                    onClick={() => handleLinkClick({ href: '/mosc-old/pilgrim-centres', label: 'PILGRIM CENTRES', isInternal: true })}
                  ...
                  <button
                    onClick={() => handleLinkClick({ href: '/mosc-old/publications/malankara-sabha-magazine-masika', label: 'MALANKARA SABHA MAGAZINE', isInternal: true })}
                    className="w-full bg-warning text-warning-foreground rounded-md py-2 px-4 text-sm font-body font-medium hover:bg-warning/90 reverent-transition"
                  >
        ...
        <div className="mt-12">
          <div className="bg-muted/20 rounded-lg p-6">
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm font-body text-muted-foreground">
              ...
              <span>•</span>
              <button
                onClick={() => handleLinkClick({ href: '/mosc-old/downloads', label: 'DOWNLOADS', isInternal: true })}
                className="hover:text-primary reverent-transition"
              >
                DOWNLOADS
              </button>
              ...
              <button
                onClick={() =>
                  handleLinkClick({
                    href: '/mosc-old/contact-form-email',
                    label: 'E-MAIL',
                    isInternal: true,
                  })
                }
              ...
              <span>•</span>
              <button
                onClick={() => handleLinkClick({ href: '/mosc-old/gallery', label: 'GALLERY', isInternal: true })}
                className="hover:text-primary reverent-transition"
              >
                GALLERY
              </button>
              <span>•</span>
              <button
                onClick={() => handleLinkClick({ href: '/mosc-old/contact-info', label: 'CONTACT INFO', isInternal: true })}
                className="hover:text-primary reverent-transition"
              >
                CONTACT INFO
              </button>
