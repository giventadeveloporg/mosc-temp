...
const BackToTopButton = () => {
  ...
  return (
    <a
      href="#"
      onClick={scrollToTop}
      className={`fixed bottom-10 right-10 z-50 bg-[#F9C23C] text-black w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-transform duration-300 ease-in-out ${
