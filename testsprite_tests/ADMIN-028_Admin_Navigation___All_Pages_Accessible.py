...
async def run_test():
    ...
    try:
        ...
        # -> Check if there is any link or button on the current page or homepage to access admin page or retry navigation with a different approach.
        ...
        await expect(frame.locator('text=Take a look at our recent events and community gatherings (showing up to 6 events)').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=See Event Details').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=New Year (Copy)_2').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=bnbnbbnb').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=giventauser@gmail.com').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=ddddddd Joseph').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=nbnbnbnbnbbnb').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=bvbvbvbv').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Manaoj Joseph').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=nnnbnbbnbnbnbnbb').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=Grateful for the support of our amazing sponsors who make our events and community initiatives possible').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=Manorama Media Partner').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=View Sponsor Details').first).to_be_visible(timeout=30000)
        ...
        await expect(frame.locator('text=See All Sponsors').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Contact').first).to_be_visible(timeout=30000)
