...
async def run_test():
    ...
    try:
        ...
        # -> Click on the link or button that navigates to the sponsors page (/sponsors)
        frame = context.pages[-1]
        # Click on 'See All Sponsors' link to navigate to sponsors page
        ...
        await expect(frame.locator('text=Showing 2 sponsors').first).to_be_visible(timeout=30000)
